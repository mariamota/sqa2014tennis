...
Scenario: Second player wins straight at 5 sets
     Given: "Jimmy Connors" and "John McEnroe" start a match to "5" sets
...
Scenario: 2nd player wins split at 5 sets
     ...
     Then: The match score is: "Boris Becker defeated Ivan Lendl | 6-2, 6-4, 7-5, 3-6, 1-6"